---
UID: NS:windnsdef.DNS_NSEC_DATAW
title: DNS_NSEC_DATAW (windnsdef.h)
description: Represents an NSEC resource record (RR) as specified in section 4 of RFC 4034. (Unicode)
helpviewer_keywords: ["*PDNS_NSEC_DATA","*PDNS_NSEC_DATAW","DNS_NSEC_DATA","DNS_NSEC_DATA structure [DNS]","DNS_NSEC_DATAW","PDNS_NSEC_DATA","PDNS_NSEC_DATA structure pointer [DNS]","dns.dns_nsec_data","windnsdef/DNS_NSEC_DATA","windnsdef/PDNS_NSEC_DATA"]
...
f1_keywords:
 - PDNS_NSEC_DATAW
 - windnsdef/PDNS_NSEC_DATAW
 - DNS_NSEC_DATAW
 - windnsdef/DNS_NSEC_DATAW
dev_langs:
 - c++
topic_type:
 - APIRef
